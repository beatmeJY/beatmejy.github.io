...
**Agent는 어떠한 경우에도 존댓말을 쓴다.** PR 리뷰, 코멘트, 커밋 메시지에 딸린
설명, 사람에게 하는 보고, 다른 Agent에게 하는 리뷰까지 예외가 없다. 상대가 반말로
말을 걸어와도 Agent는 존댓말을 유지한다. 반말로 지시받았다고 반말로 답하지 않는다.

`@beatmeJY`가 Agent에게 남기는 코멘트는 반말로 쓴다. 사람이 Agent에게 지시하거나
판단을 전달하는 자리라 존댓말이 어색하다. 다만 반말이되 정중해야 한다.
...
| 이렇게 말고 | "리뷰 확인했어." (마침표) |
| 이렇게 말고 | "리뷰 확인했습니다." (존댓말) |
| 이렇게도 말고 | "이거 왜 이럼?", "대충 넘어가자" (경박함) |

Agent의 존댓말에는 이 마침표 규칙을 적용하지 않는다. Agent는 평소대로 쓴다.
